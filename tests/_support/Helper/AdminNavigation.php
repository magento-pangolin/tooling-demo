...
class AdminNavigation extends AcceptanceTester
{
    ...
    public function loginAsAdmin($username = null, $password = null)
    {
        ...
        $this->fillField('login[username]', !is_null($username) ? $username : 'admin');
        $this->fillField('login[password]', !is_null($password) ? $password : '123123q');
        $this->click('Sign in');
